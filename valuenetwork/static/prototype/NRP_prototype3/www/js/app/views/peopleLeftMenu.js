...
define([
	...
	'underscore_1.3.3',
	'backbone_0.9.2',
	'text!../../../templates/peopleLeftMenu.html'
], function ($, _, Backbone, peopleLeftMenu) {
	'use strict';

	var PeopleLeftMenu = Backbone.View.extend({

		tagName:  'div',
    
    el: '#leftMenu',

		template: _.template(peopleLeftMenu),
